...
find_path(
  DETOURS_INCLUDE_DIR
  NAMES detours.h
  HINTS ENV DETOURS_PATH ${DETOURS_PATH} ${OBS_SOURCE_DIR}/${DETOURS_PATH} ${_DETOURS_INCLUDE_DIRS}
...
find_library(
  ...
  HINTS ENV DETOURS_PATH ${DETOURS_PATH} ${OBS_SOURCE_DIR}/${DETOURS_PATH} ${_DETOURS_LIBRARY_DIRS}
