...
find_path(
  RNNOISE_INCLUDE_DIR
  NAMES rnnoise.h
  HINTS ENV RNNOISE_PATH ${RNNOISE_PATH} ${OBS_SOURCE_DIR}/${RNNOISE_PATH} ${_RNNOISE_INCLUDE_DIRS}
...
find_library(
  ...
  HINTS ENV RNNOISE_PATH ${RNNOISE_PATH} ${OBS_SOURCE_DIR}/${RNNOISE_PATH} ${_RNNOISE_LIBRARY_DIRS}
